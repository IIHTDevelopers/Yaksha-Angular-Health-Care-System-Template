...
describe('MealPlanService', () => {
  ...
  describe('business', () => {
    ...
    it('should fetch all meal plans', () => {
      ...
      service.getAllMealPlans().subscribe((mealPlans: any) => {
    ...
    it('should get meal plan by ID', () => {
      ...
      service.getMealPlanById(1).subscribe((mealPlan: any) => {
    ...
    it('should create a new meal plan', () => {
      ...
      service.createMealPlan(newMealPlan).subscribe((mealPlan: any) => {
    ...
    it('should update meal plan', () => {
      ...
      service.updateMealPlan(1, updatedMealPlan).subscribe((mealPlan: any) => {
    ...
    it('should delete meal plan', () => {
      service.deleteMealPlan(1).subscribe((response: any) => {
