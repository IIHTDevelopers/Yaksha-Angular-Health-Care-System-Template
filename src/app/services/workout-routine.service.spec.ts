...
describe('WorkoutRoutineService', () => {
  ...
  describe('business', () => {
    ...
    it('should fetch all workout routines', () => {
      ...
      service.getAllWorkoutRoutines().subscribe(workoutRoutines => {
    ...
    it('should get workout routine by ID', () => {
      ...
      service.getWorkoutRoutineById(1).subscribe(workoutRoutine => {
    ...
    it('should create a new workout routine', () => {
      ...
      service.createWorkoutRoutine(newWorkoutRoutine).subscribe(workoutRoutine => {
    ...
    it('should update workout routine', () => {
      ...
      service.updateWorkoutRoutine(1, updatedWorkoutRoutine).subscribe(workoutRoutine => {
    ...
    it('should delete workout routine', () => {
      service.deleteWorkoutRoutine(1).subscribe(response => {
