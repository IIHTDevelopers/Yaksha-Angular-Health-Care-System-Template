...
describe('MeditationExerciseService', () => {
  ...
  describe('business', () => {
    ...
    it('should fetch all meditation exercises', () => {
      ...
      service.getAllMeditationExercises().subscribe((meditationExercises: any) => {
    ...
    it('should get meditation exercise by ID', () => {
      ...
      service.getMeditationExerciseById(1).subscribe((meditationExercise: any) => {
    ...
    it('should create a new meditation exercise', () => {
      ...
      service.createMeditationExercise(newMeditationExercise).subscribe((meditationExercise: any) => {
    ...
    it('should update meditation exercise', () => {
      ...
      service.updateMeditationExercise(1, updatedMeditationExercise).subscribe((meditationExercise: any) => {
    ...
    it('should delete meditation exercise', () => {
      service.deleteMeditationExercise(1).subscribe((response: any) => {
